        ...
        >
          ...
          <View className="flex-row h-4 bg-gray-200 rounded-full overflow-hidden">
            <View
                ...
                style={{ width: `${analysis?.nutritionFacts.macronutrientDistribution.proteinPercentage}%` }}
            />
            <View
                className="bg-green-500"
                style={{ width: `${analysis?.nutritionFacts.macronutrientDistribution.carbsPercentage}%` }}
            />
            <View
                className="bg-amber-500"
                style={{ width: `${analysis?.nutritionFacts.macronutrientDistribution.fatPercentage}%` }}
            />
          </View>
        ...
        {/* Detailed Nutrition */}
          ...
          >
              ...
              <View className="bg-card rounded-xl p-5">
                  ...
                  {/* Data Rows */}
                  {Object.entries(analysis?.nutritionFacts?.perPortion ?? {}).map(([key, value]) => (
                      <View
                          key={key}
                      ...
                      >
                          ...
                          <Text className="w-1/3 text-center">{value}</Text>
                          <Text className="w-1/3 text-right">{analysis?.nutritionFacts?.per100g[key] ?? ''}</Text>
                      </View>
                  ))}
              </View>
          </Animated.View>
